...
public class MyScrumTeam {
    public static void main(String[] args) {
        ...
        day31_Constructors.scrumTask.Developer developer1 = new day31_Constructors.scrumTask.Developer("Olga", 22, "Java day33_Statics.Developer", 125000);
        day31_Constructors.scrumTask.Developer developer2= new day31_Constructors.scrumTask.Developer("Aygun", 39, "Java Master", 185000);
        day31_Constructors.scrumTask.Developer developer3 = new day31_Constructors.scrumTask.Developer("Tunc", 28, "Software day33_Statics.Developer", 135000);
        day31_Constructors.scrumTask.Developer developer4= new day31_Constructors.scrumTask.Developer("Sinem", 13, "Senior day33_Statics.Developer",200000);

        day31_Constructors.scrumTask.Developer[] developers = {developer2, developer3, developer4};

        // 1 day33_Statics.ScrumTeam Object
...
class Developer{
    ...
    public String toString() {
        return "day33_Statics.Developer{" +
                "name='" + name + '\'' +
                ", employeeID=" + employeeID +
                ", jobTitle='" + jobTitle + '\'' +
                ", salary= $" + salary +
...
class ScrumTeam{
    ...
    public String toString() {
        return "day33_Statics.ScrumTeam{" +
                "PO='" + PO + '\'' +
                ", BA='" + BA + '\'' +
                ", SM='" + SM + '\'' +
